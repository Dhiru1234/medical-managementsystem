...
<body style="background-repeat: no-repeat; background-size: 100% 400%; background-image:url(image/6.jpg)">
						...
						<table class="table table-bordered" id="dynamic_field">
							<tr>
								...
								<td><input type="text" name="schedule[]"
									placeholder="Schedule Medicine" class="form-control name_list"
									required/></td>
