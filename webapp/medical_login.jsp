...
<title>Medicine login page</title>
...
<body style="background-repeat: no-repeat; background-size: 100% 160%; background-image:url(image/m2.jpg)">
			...
			<div class="col-md-6 offset-md-4">
				<div class="card paint-card">
					<div class="card-body" style="background-color: #EED2EE;">
						<p style="background-color: yellow;" class="fs-3 text-center">MEDICAL LOGIN</p>
